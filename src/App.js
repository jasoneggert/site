...
export default function App() {
  ...
  return (
    <Screen>
      <Name>Jason Eggert</Name>
      <Subtitle>Product  / UX / Engineer</Subtitle>
      <LinkedInLink href="https://www.linkedin.com/in/jasoneggert/">LinkedIn</LinkedInLink>
    <Canvas dpr={[1, 1.5]} camera={{ position: [0, 0, 15] }}>
      ...
      <Suspense fallback={null}>
        <Rig>
          <Triangle color="#00FFFF" scale={0.009} rotation={[0, 0, 0]} position={[-1, 1, 0]} />
          <Triangle color="#ff2060" scale={0.009} rotation={[0, 0, 0]} position={[-1, 1, 0]} />
